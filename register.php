    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#login_button").click(function(){
                if($("#input_1").val().length == 0) {
                    create_alert("You need a username");
                } else if($("#input_2").val().length < 8) {
                    create_alert("Your password has to be more than 8 characters long");
                } else if($("#input_2").val() != $("#input_3").val()) {
                    create_alert("Your passwords must match");
                } else {
                    if(checkUsernameField() != 1) {
                        create_alert("Username already taken");
                    } else {
                        $.ajax({
